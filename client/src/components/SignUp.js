...
const SignUp = (props) => {
  ...
  const clientKeyDefault = new Date().getTime() + '-REG-EXT';
            ...
            <fieldset className='text-white'>
              ...
              <div className='form-group'>
                ...
                <div className='col'>
                  ...
                  <span
                    className={
                      textAreaLength === clientText.length
                        ? 'text-danger'
                        : 'text-white'
                    }
                  >
                    {' '}
                    Max chars: ({textAreaLength}/{clientText.length})
                  </span>
                </div>
              </div>
            </fieldset>
              ...
              <div className='form-group'>
                ...
                <div className='col'>
                  <input
                    ...
                    minLength='3'
                    maxLength='30'
                    placeholder='0049.030.987.65.43'
                    value={clientPhone}
                    onChange={onChange}
                    required
                  />
              ...
              <div className='form-group'>
                ...
                <div className='col'>
                  <input
                    ...
                    minLength='3'
                    maxLength='30'
                    placeholder='0049.030.987.44.55'
                    value={clientFax}
                    onChange={onChange}
                    required
                  />
...
export default connect(mapStateToProps, { signUp, setAlert, clearErrors })(
  SignUp
);
